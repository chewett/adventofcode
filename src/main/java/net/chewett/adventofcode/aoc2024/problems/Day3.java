...
public class Day3 {
    ...
    /**
     * Given the input instructions run the multiply operations and return the total value
     * @param input Input instructions
     * @return Total value of multiplications
     */
    public long solvePartOne(String input) {
        //Just use a regex to parse the data out
    ...
    /**
     * Given the input instructions, run the multiply operations, handling the conditions and return the total value
     * @param input Input instructions
     * @return Total value of multiplications handling the conditionals
     */
    public long solvePartTwo(String input) {
        //In this tweak, use an expanded regex and handle do/don't
        ...
        long total = 0;
        while (matcher.find()) {
            String mainGroup = matcher.group();
            //Do/Don't turns on/off the elements
            if(mainGroup.equals("do()")) {
                addToTotal = true;
            }else if(mainGroup.equals("don't()")) {
                addToTotal = false;
            }else {
                if(addToTotal) {
                    int val1 = Integer.parseInt(matcher.group(2));
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The total of the multiplications is " + partOne);

        long partTwo = d.solvePartTwo(input);
        System.out.println("The total of the multiplications handling the conditions is " + partTwo);
    }
}
