...
public class Day1 {
    ...
    /**
     * Given a list of integers this will attempt to find the amount of times it goes up
     * @param ints List of ints to process
    ...
    /**
     * Given a list of integrers, attempt to find the number of times a rolling 3 sum goes up
     * @param ints List of ints to process
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Number of times the list of numbers went up " + partOne);

        long partTwo = d.solvePartTwo(ints);
        System.out.println("Number of times the rolling 3 sum went up " + partTwo);
