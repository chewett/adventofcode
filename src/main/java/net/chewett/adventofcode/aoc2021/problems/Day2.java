...
public class Day2 {
    ...
    /**
     * Pilot the submarine according to the given set of instructions
     * @param instructions List of instructions to follow
     * @return Return the final depth multiplied by the final horizontal value
     */
    ...
    /**
     * Pilots the submarine according to the instructions using our new understanding of how to read the instructions
     * @param instructions List of instructions to follow
     * @return Return the final depth multiplied by the final horizontal value
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The final depth multiplied by the final horizontal value is " + partOne);

        long partTwo = d.solvePartTwo(instructions);
        System.out.println("After changing how we parse the instructions, the final depth multiplied by the final horizontal value is " + partTwo);
