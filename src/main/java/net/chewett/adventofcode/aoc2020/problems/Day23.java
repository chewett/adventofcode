 ...
 * increasing fashion starting from the number after the highest number in your list and proceeding one by one until one
 * million is reached. (For example, if your labeling were 54321, the cups would be numbered 5, 4, 3, 2, 1, and then
 * start counting up from 6 until one million is reached.) In this way, every number from one through one million is
 * used exactly once.
 *
...
public class Day23 {
    ...
    /**
     * Play the Crap Cups game and return the order of the labels on the cups
     * @param input Initial labelling of the cups
     * @return Final labelling of the cups as an int
     */
    public long solvePartOne(String input) {
        ...
        //Here we run the majority of the code in the CrabCupGame class
        CrabCupGame cc = new CrabCupGame(cups);
        return cc.runGameForMoves(100);

    }

    /**
     * Play the Crap Cups game and return the multiplication of the two cups clockwise of cup one
     * @param input Initial labelling of the cups
     * @return Multiplication of the two cups clockwise from label one.
     */
    public long solvePartTwo(String input) {
        ...
        //Here we run the majority of the code in the CrabCupLinkedListGame class
        //This one is designed to work with many many moves and cups, which the other one would be insanely slow at
        CrabCupLinkedListGame cc = new CrabCupLinkedListGame(cups);
        return cc.runGameForMoves(10000000);
    }


    public static void main(String[] args) {
        Day23 d = new Day23();
        String input = ProblemLoader.loadProblemIntoString(2020, 23);

        long p1 = d.solvePartOne(input);
        System.out.println("The ordering of the cups after the game is " + p1);
        long p2 = d.solvePartTwo(input);
        System.out.println("The multiplication of the two cups clockwise from the label one is " + p2);
