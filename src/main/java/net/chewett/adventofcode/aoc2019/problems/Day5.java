 ...
 * indicate opcode 2, multiplication. Then, going right to left, the parameter modes are
 * 0 (hundreds digit), 1 (thousands digit), and 0 (ten-thousands digit, not present and therefore zero):
 *
 * ABCDE
 *  1002
 *
