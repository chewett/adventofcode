...
public class Day1 {
    ...
    public long solvePartOne(List<Integer> input) {
        ...
        for(int newModuleMass : input) {
            s.addModule(new SpaceshipModule(newModuleMass));
        }

        return s.getFuelForModules();
    }
    ...
    public long solvePartTwo(List<Integer> input) {
        ...
        return s.getFuelForModulesCountingFuelMass();
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total fuel just counting module weight: " + partOne);

        long partTwo = d.solvePartTwo(input);
        System.out.println("Total fuel needed counting fuel and module weight: " + partTwo);
    }
}
