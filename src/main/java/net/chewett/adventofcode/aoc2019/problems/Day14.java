...
/**
 * Awesome problem taken from: https://adventofcode.com/2019/day/14
...
public class Day14 {
    ...
    public long solvePartOne(List<String> input) {
        ...
        //Keep going until we make one fuel
        while(chemicalPool.get(fuel) == 0) {
            ReactionChemical currentlyNeeds = fuel;
            boolean foundReactionToRun = false;
            //Start from the base, work out what means I can't generate this and then generate that (could be a long chain)
            ...
            while(!foundReactionToRun) {
                ...
                if(canRun) {
                    ...
                    //Work out what is needed and try to generate that
        ...
        return MAX_ORE - chemicalPool.get(ore);
    }
    ...
    public long solvePartTwo(List<String> input) {
        ...
        while(!cantRunReaction) {
            int timesToRun;
            //FIXME: Cheat to speed up calculations for my inputs, still relatively slow, needs being made smarter
            ...
            while(!foundReactionToRun && !cantRunReaction) {
                ...
                if(canRun) {
                    ...
                    //Keep going until we run out of ore
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The minimum number of ore needed to produce one fuel is " + partOne);

        long partTwo = d.solvePartTwo(input);
        System.out.println("The maximum amount of fuel I can produce is " + partTwo);
    }
}
